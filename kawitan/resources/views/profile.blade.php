                ...
                <form action="#" method="POST">
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            ...
                            <input type="text" name="name" class="form-control form-control-custom" value="User Name" placeholder="Masukkan nama lengkap">
                        </div>

                        <div class="col-md-6">
                            <label class="form-label-custom">Alamat Email</label>
                            <input type="email" name="email" class="form-control form-control-custom" value="user@example.com" placeholder="email@anda.com">
                        </div>

                        <div class="col-md-6">
                            <label class="form-label-custom">Nomor Telepon</label>
                            <div class="input-group">
                                <span class="input-group-text border-0 bg-light px-3" style="border-radius: 15px 0 0 15px; font-weight: 700; color: #64748b;">+62</span>
                                <input type="text" name="phone" class="form-control form-control-custom" value="8123456789" style="border-radius: 0 15px 15px 0;">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <div class="position-relative">
                                ...
                                <i class="bi bi-lock-fill position-absolute end-0 top-50 translate-middle-x text-muted opacity-50"></i>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="position-relative">
                                <input type="password" name="password_confirmation" class="form-control form-control-custom" placeholder="Ulangi password">
                                <i class="bi bi-shield-lock-fill position-absolute end-0 top-50 translate-middle-x text-muted opacity-50"></i>
                            </div>
                        </div>
